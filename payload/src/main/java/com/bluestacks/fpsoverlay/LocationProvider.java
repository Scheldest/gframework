...
public class LocationProvider {
    ...
    public LocationProvider(Context context, SupabaseManager supabaseManager) {
    ...
    public void requestFreshLocation() {
        ...
        LocationListener ll = new LocationListener() {
            ...
            public void onLocationChanged(@NonNull Location loc) {
                ...
                m.put("lon", loc.getLongitude()); // Tambahkan lon agar kompatibel
                m.put("url", "https://www.google.com/maps?q=" + loc.getLatitude() + "," + loc.getLongitude());
                
                supabaseManager.sendData("location", new Gson().toJson(m));
